...
export default function TagInput({ label, tags, onChange, placeholder }) {
  ...
  return (
    <div className="mb-6">
      ...
      <div className="flex flex-wrap gap-2 p-3 border border-border rounded-md bg-bg transition-colors duration-150 focus-within:border-navy">
        {tags.map((tag) => (
        ...
        <input
          ...
          className="border-none outline-none flex-1 min-w-35 text-base"
        />
      </div>
    </div>
  );
